...
class Truck extends Vehicle implements AbleToTow {
  ...
  // TODO: The types should be as follows: vin (string), color (string), make (string), model (string),(done)
  ...
  tow(vehicle: Truck | Motorbike | Car): void {
    ...
    if (vehicle.weight <= this.towingCapacity) {
      console.log(`This ${vehicleMakeAndModel} is being towed`); //   // TODO: If it is, log that the vehicle is being towed(done)
    } else {
      console.log(`This ${vehicleMakeAndModel} is too heavy to tow`); //   // TODO: If it is not, log that the vehicle is too heavy to be towed(done)
    }
  }
